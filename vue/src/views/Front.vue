      ...
      <div class = "top-nav-wrapper">
        <div class="top-nav">
          <el-menu
            ...
            <el-menu-item class = "nav-sub-item"  index="/front/zxjs">中心介绍</el-menu-item>
            <el-menu-item class = "nav-sub-item"  index="/front/Lsyg">历史沿革</el-menu-item>
            <el-menu-item class = "nav-sub-item"  index="/front/Zxjg">中心机构</el-menu-item>
            </el-submenu>

            <el-submenu index="3">
              <template slot="title" >师资力量</template>
              <el-menu-item class = "nav-sub-item"   index="/front/Zrjs">专任教师</el-menu-item>
              <el-menu-item class = "nav-sub-item"   index="/front/Syjsry">实验技术人员</el-menu-item>
              <el-menu-item class = "nav-sub-item"   index="/front/Jrjs">兼任教师</el-menu-item>
            </el-submenu>

            <el-submenu class="nav-01" index="/front/sysgk" >
              <template slot="title" >
                  实验教学
<!--                北大网站这个子菜单是没有的,但是缝合一下xjtu的"实验教学"子菜单, 里面有各种近代物理前沿物理等等-->
                </template>
              <el-menu-item class = "nav-sub-item"   index="/front/sysgk">实验室概况</el-menu-item>
              <el-menu-item class = "nav-sub-item"   index="/front/dxwlsy">大学物理实验</el-menu-item>
              <el-menu-item class = "nav-sub-item"   index="/front/zywlsy">专业物理实验</el-menu-item>
              <el-menu-item class = "nav-sub-item"   index="/front/jdwlsy">近代物理实验</el-menu-item>
              <el-menu-item class = "nav-sub-item"   index="/front/zhwlsy">综合物理实验</el-menu-item>
            </el-submenu>

            <el-submenu index="5">
              <template slot="title" >规章制度</template>
              <el-menu-item class = "nav-sub-item"   index="/front/zxglbf">国家级实验教学示范中心管理办法</el-menu-item>
              <el-menu-item class = "nav-sub-item"   index="/front/gztl">西安交通大学实验室工作条例</el-menu-item>
              <el-menu-item class = "nav-sub-item"   index="/front/glbf">西安交通大学实验室安全管理办法</el-menu-item>
              <el-menu-item class = "nav-sub-item"   index="/front/sbglbf">西安交通大学仪器设备管理办法</el-menu-item>
              <el-menu-item class = "nav-sub-item"   index="/front/glzd">实验室管理制度</el-menu-item>
              <el-menu-item class = "nav-sub-item"   index="/front/jtgd">关于实验室安全的具体规定</el-menu-item>
              <el-menu-item class = "nav-sub-item"   index="/front/pczd">赔偿制度</el-menu-item>
...
<!--            </el-menu-item>-->
            ...
            <el-menu-item >
<!--              放一个链接跳到爱课程-->
              <a href="https://www.icourses.cn/sCourse/course_6495.html">精品课程</a>
            </el-menu-item>
<!--            <el-menu-item class="nav-item-01" index="6">-->
<!--              <a class="el-menu-text" href="Front.vue">规章制度</a>-->
<!--            </el-menu-item>-->

            <el-menu-item index="/front/Kcsz">
              课程思政
            </el-menu-item>
