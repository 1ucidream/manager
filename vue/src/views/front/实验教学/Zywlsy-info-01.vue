        ...
        <div class="info-box-right-wrapper">
          ...
          <div class="info-box-right">
            ...
            <el-breadcrumb class="breadcrumb-02" >
              ...
              <el-breadcrumb-item :to="{ path: '/front/zywlsy' }">专业物理实验</el-breadcrumb-item>
              <el-breadcrumb-item :to="{ path: '/front/zywlsy-info-01' }">正文</el-breadcrumb-item>

            </el-breadcrumb>

              <div class="wz-title"> 专业物理实验 </div>

              <div style=" height: auto;  ">

                <a href="https://epc.xjtu.edu.cn/system/_content/download.jsp?urltype=news.DownloadAttachUrl&owner=1577422019&wbfileid=5294231"
                style="float: left !important; height: 55px; padding-top: 30px">附件: 凝聚态物理实验讲义(点击下载)</a>
