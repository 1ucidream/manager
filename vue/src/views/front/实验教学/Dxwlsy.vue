      ...
      <div class="info-box">
        ...
        <div class="info-box-right-wrapper">
          ...
          <div class="info-box-right">
            ...
            <el-breadcrumb class="breadcrumb-02" >
              ...
              <el-breadcrumb-item :to="{ path: '/front/dxwlsy' }">大学物理实验</el-breadcrumb-item>
            </el-breadcrumb>

              <div class="wz-title"> 大学物理实验 </div>

              <div class="wz-list">
                <ul class="wz-list-ul">

                  <li class="wz-list-li">
                    <a href="/front/Dxwlsy-info-01" title="大学物理实验绪论（视频）" class="wz-list-a">大学物理实验绪论（视频）</a><p class="wz-list-p">2019-09-12</p>
                  </li>
                  <li class="wz-list-li">
                    <a class="wz-list-a">大学物理实验讲义</a><p class="wz-list-p">2019-09-12</p>
                  </li>
                  <li class="wz-list-li">
                    <a href="https://epc.xjtu.edu.cn/system/_content/download.jsp?urltype=news.DownloadAttachUrl&owner=1577422019&wbfileid=5294231" title="大学物理实验绪论（视频）" class="wz-list-a">大学物理实验绪论（视频）</a><p class="wz-list-p">2019-09-12</p>
                  </li>
