              ...
              <el-row class="tac">
                <el-col :span="12">
                  <el-menu
                    ...
                    <el-menu-item :to="{ path: '/front/zrjs' }" class="el-leftmenu-item" index="/front/zrjs">
                      <i class="el-icon-user-solid"></i>
                      <span slot="title">专任教师</span>
                    </el-menu-item>
                    <el-menu-item :to="{ path: '/front/syjsry' }" class="el-leftmenu-item" index="/front/syjsry" >
                      <i class="el-icon-service"></i>
                      <span slot="title">实验技术人员</span>
                    </el-menu-item>
                    <el-menu-item :to="{ path: '/front/jrjs' }" class="el-leftmenu-item" index="/front/jrjs">
                      <i class="el-icon-user"></i>
                      <span slot="title">兼任教师</span>
                    </el-menu-item>
                  </el-menu>
                </el-col>
              </el-row>
        ...
        <div class="xw-box-right-wrapper">
          ...
          <div class="xw-box-right">
            ...
            <el-breadcrumb separator-class="el-icon-arrow-right" >
              ...
              <el-breadcrumb-item>兼任教师</el-breadcrumb-item>
            </el-breadcrumb>
            <el-divider content-position="center">普通物理实验（基础物理实验）兼任教师</el-divider>
            <div class="wz-jrjs-nav">
              &nbsp;&nbsp;&nbsp;&nbsp;陈剑豪、戴伦、杜红林、付恩刚、高鹏、高宇南、郝建奎、何庆林、侯玉敏、黄斐增、黄森林、江颖、蒋红兵、李方廷、李峰、李源、林峰、林熙、刘开辉、楼建玲、卢晓波、路建明、罗昭初、吕国伟、马平、马仁敏、曲波、冉广照、沈路路、施可彬、史俊杰、、孙栋、孙小虎、王常生、王晨旭、王宏利、王剑威、王健、王茂俊、王思广、王新强、王越、王智、吴成印、吴孝松、肖云峰、谢大弢、许福军、许秀来、薛建明、杨根、杨丽敏、杨振伟、叶堉、俞妍、张家森、张锦文、张双全、张熙博、张晓东、张艳席、张焱、赵强、赵清、赵子强、周辰
            </div>
            <el-divider content-position="center">近代物理实验课兼任教师</el-divider>
            <div class="wz-jrjs-nav">
              &nbsp;&nbsp;&nbsp;&nbsp;江颖、刘开辉、吴孝松、许福军、冉广照、楼建玲、黄斐增、张双全、王思广、杜红林、王常生、王越、叶堉、路建明、薛建明、赵子强、付恩刚、刘阳、胡小永，和更多青年教师.
            </div>
          </div>
...
.wz-jrjs-nav {
  margin-top: 30px;
  font-family: "黑体", HeiTi, "Microsoft YaHei","Arial", sans-serif; /* 设置字体样式，可以根据需要更改 */
  font-size: 18px; /* 设置字体大小，可以根据需要更改 */
...
/*左侧导航栏宽度*/
.custom-menu-width {
  width: 300px !important; /* 设置宽度为180px，根据实际需要调整 */
}
/* 修改悬停颜色和字体颜色 */
.top-nav-leftmenu{
  width: 100%;
